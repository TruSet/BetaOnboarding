...
describe('<Home />', () => {
  ...
  it('should render a modal when the button is clicked', () => {
    ...
    expect(component.find('div.walkthroughModal-background-0-1-5').exists()).toBe(false)
    component.setState({modal: true})
    expect(component.find('div.walkthroughModal-background-0-1-5').exists()).toBe(true)
